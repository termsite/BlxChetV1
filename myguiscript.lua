...
local Window = Library.CreateLib("BlxChet V1", "Synapse")

local Player = Window:NewTab("LocalPlayer")
local MainSection = Player:NewSection("Local Player Scripts")

MainSection:NewButton("Fly | R-Start E-Stop", "It's In The Name", function()
...
local function startJumping()
    ...
    while isJumping do
        ...
        wait(0.1) -- Adjust the wait time as needed for the desired jump frequency
    end
end
...
MainSection:NewButton("TP To Closest Player | Press F", "ButtonInfo", function()
...
MainSection:NewButton("Lock Character | Press G", "ButtonInfo", function()
...
MainSection:NewButton("Back/Front Flip | Press Z/X", "ButtonInfo", function()
...
-- NEW TAB
local Other = Window:NewTab("OtherPlayers")
local OtherSection = Other:NewSection("Effects Other Players")



-- NEW TABBB
local Random = Window:NewTab("Random")
local RandomSection = Random:NewSection("Random Scripts")

RandomSection:NewButton("Inf Yield", "Admin Cmds", function()
...
local infoSection = info:NewSection("Info And More!")
